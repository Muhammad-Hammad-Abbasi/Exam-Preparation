# Topic Breakdown for MCQs
---
### 1). Next.js Basics.
### 2). Routing in Next.js.
### 3). Data Fetching.
- SSR (getServerSideProps).
- SSG (getStaticProps and getStaticPaths).
...
14). Server-Side Rendering (getServerSideProps)
When is getServerSideProps called?
...
11). In Next.js, what happens when fallback: "blocking" is used?
...
2). How do you type the return of useSWR in Next.js with TypeScript?
...
3). Which type ensures proper typing for context in getServerSideProps?
...
4). When typing the result of getStaticPaths, what type is used?
...
5). What type should be used to handle dynamic params in getStaticProps?
...
6). How can you infer the return type of getStaticProps?
...
7). What is the default return type for useEffect-based client-side data fetching?
...
8). How do you type a SWR mutation function in Next.js?
...
9). Can you use TypeScript to enforce return types in getServerSideProps?
